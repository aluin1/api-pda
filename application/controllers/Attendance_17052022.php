...
public function edit_wr_post()
	...
	public function sendemail_post()
	{
		...
		$_POST = $this->security->xss_clean($_POST);
		// Form Validation
		//$this->form_validation->set_rules('url', 'url', 'trim|required|max_length[max]');
		//$this->form_validation->set_rules('subject', 'subject', 'trim|required|max_length[max]'); 
		//$this->form_validation->set_rules('body', 'body', 'trim|required|max_length[max]'); 
		//$this->form_validation->set_rules('cc', 'cc email', 'trim|required|max_length[max]'); 
		//$this->form_validation->set_rules('bcc', 'bcc email', 'trim|required|max_length[max]'); 
		$this->form_validation->set_rules('email', 'email karyawan', 'trim|required|max_length[1000]'); 
	...
	foreach ($dturl   as $row_url)	
		...
		$subject = $row_subject->FITUR_KEYVALUE;
		$body = $row_body->FITUR_KEYVALUE;
		$cc =  $row_cc->FITUR_KEYVALUE;
